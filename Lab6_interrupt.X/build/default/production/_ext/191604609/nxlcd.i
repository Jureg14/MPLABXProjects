...
# 9 "../ProjetoF_micro.X/nxlcd.c" 2

# 1 "../ProjetoF_micro.X/nxlcd.h" 1
# 92 "../ProjetoF_micro.X/nxlcd.h"
...
# 113 "../ProjetoF_micro.X/nxlcd.c"
void SetCGRamAddr(unsigned char CGaddr)
{
# 128 "../ProjetoF_micro.X/nxlcd.c"
        TRISD &= 0x0f;
        PORTD &= 0x0f;
...
# 171 "../ProjetoF_micro.X/nxlcd.c"
void SetDDRamAddr(unsigned char DDaddr)
{
# 186 "../ProjetoF_micro.X/nxlcd.c"
        TRISD &= 0x0f;
        PORTD &= 0x0f;
...
# 287 "../ProjetoF_micro.X/nxlcd.c"
unsigned char ReadAddrXLCD(void)
{
        char data;
# 301 "../ProjetoF_micro.X/nxlcd.c"
        LATEbits.LATE2 = 1;
        LATEbits.LATE0 = 0;
        DelayFor18TCY();
        LATEbits.LATE1 = 1;
...
# 338 "../ProjetoF_micro.X/nxlcd.c"
char ReadDataXLCD(void)
{
        char data;
# 353 "../ProjetoF_micro.X/nxlcd.c"
        LATEbits.LATE2 = 1;
        LATEbits.LATE0 = 1;
        DelayFor18TCY();
        LATEbits.LATE1 = 1;
...
# 388 "../ProjetoF_micro.X/nxlcd.c"
void WriteCmdXLCD(unsigned char cmd)
{
# 403 "../ProjetoF_micro.X/nxlcd.c"
        TRISD &= 0x0f;
        PORTD &= 0x0f;
        PORTD |= cmd&0xf0;
...
# 449 "../ProjetoF_micro.X/nxlcd.c"
void WriteDataXLCD(char data)
{
# 464 "../ProjetoF_micro.X/nxlcd.c"
        TRISD &= 0x0f;
        PORTD &= 0x0f;
        PORTD |= data&0xf0;
