...
# 2 "<built-in>" 2
# 1 "../ProjetoF_micro.X/main.c" 2
# 15 "../ProjetoF_micro.X/main.c"
...
# 80 "../ProjetoF_micro.X/main.c" 2
# 89 "../ProjetoF_micro.X/main.c"
...
volatile unsigned int tempuu = 9;
...
void main(void) {
    ...
    while (1) {
        ...
        stringTempo[0] = (tempuu / 10) + '0';
        stringTempo[1] = (tempuu % 10) + '0';
        stringTempo[2]='\0';
...
char readKey() {
    ...
    for (int col = 0; col < 4; col++) {
        ...
        for (int row = 0; row < 4; row++) {
            if (!(PORTB & (1 << (row + 4)))) {
                currentKey = keymap[row][InvCol[col]];
                return currentKey;
            }
        }
    }
...
void displayStuff(char key, float V_analog) {
    ...
    putsXLCD("Vin:");
    WriteCmdXLCD(0xCC);
    WriteDataXLCD(inteiro + '0');
    WriteDataXLCD('.');
    WriteDataXLCD((decimal / 10) + '0');
    WriteDataXLCD((decimal % 10) + '0');
}
